...
const debug = createDebug('kwskfs-line-ticket:user');
...
export default class User {
    ...
    constructor(configurations: IConfigurations) {
        ...
        this.rekognitionCollectionId = `kwskfs-line-ticket-${this.userId}`;
    ...
    public async saveTransaction(transaction: kwskfsapi.factory.transaction.placeOrder.ITransaction) {
        await redisClient.multi()
