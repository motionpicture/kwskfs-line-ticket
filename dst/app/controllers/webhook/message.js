...
const debug = createDebug('kwskfs-line-ticket:controller:webhook:message');
/**
 * 使い方を送信する
 * @export
 */
                    ...
                    messages: [
                        {
                            ...
                            template: {
                                ...
                                columns: ownershipInfos.map((ownershipInfo) => {
                                    ...
                                    // tslint:disable-next-line:max-line-length
                                    `${(itemOffered.reservedTicket.ticketedSeat !== undefined) ? itemOffered.reservedTicket.ticketedSeat.seatNumber : ''}`);
                                    return {
